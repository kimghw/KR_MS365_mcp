...
Usage:
    python streamable_http_probe.py --base http://localhost:8091
    python streamable_http_probe.py --base http://localhost:8091 --json
    python streamable_http_probe.py --base http://localhost:8091 --strict
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    parser.add_argument(
        "--base",
        required=True,
        help="Server base URL (e.g. http://localhost:8091). /mcp is appended automatically.",
    )
    parser.add_argument(
        "--json",
        action="store_true",
