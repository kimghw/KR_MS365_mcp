"""STDIO MCP Server for mcp_calendar.
...
BOOT = bootstrap_stdio(__file__, package_name="mcp_calendar")

from mcp_common.stdio_transport import run_stdio

from mcp_calendar.mcp_server.handlers import build_mcp_server, lifecycle
