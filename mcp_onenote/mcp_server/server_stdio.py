"""STDIO MCP Server for mcp_onenote.
...
BOOT = bootstrap_stdio(__file__, package_name="mcp_onenote")

from mcp_common.stdio_transport import run_stdio

from mcp_onenote.mcp_server.handlers import build_mcp_server, lifecycle
