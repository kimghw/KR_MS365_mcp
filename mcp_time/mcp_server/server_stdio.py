"""STDIO MCP Server for mcp_time. 인증 불필요.
...
BOOT = bootstrap_stdio(__file__, package_name="mcp_time")

from mcp_common.stdio_transport import run_stdio

from mcp_time.mcp_server.handlers import build_mcp_server, lifecycle
