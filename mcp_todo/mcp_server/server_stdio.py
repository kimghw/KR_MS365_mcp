"""STDIO MCP Server for mcp_todo (Microsoft To Do).
...
BOOT = bootstrap_stdio(__file__, package_name="mcp_todo")

from mcp_common.stdio_transport import run_stdio

from mcp_todo.mcp_server.handlers import build_mcp_server, lifecycle
